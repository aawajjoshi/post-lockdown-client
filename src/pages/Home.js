      ...
      <Segment.Group style={{ border: "none", boxShadow: "none" }}>
        <Responsive as={Segment} {...Responsive.onlyComputer}>
          <Grid columns={3} style={{background: 'rgba(240, 238, 234, .3)'}}>
            <Grid.Row className="page-title">
              <h1 style={{fontFamily:`'Proza Libre', sans-serif`, fontSize: 'calc(30px + 1vw)', color: 'teal', marginBottom: '3%'}}>Post lockdown, I ...</h1>
            </Grid.Row>
            <Grid.Row>
              {user && (
                <Grid.Column>
        ...
        <Responsive as={Segment} {...Responsive.onlyTablet}>
          <Grid columns={2} style={{background: 'rgba(240, 238, 234, .3)'}}>
            <Grid.Row className="page-title">
              <h1 style={{fontFamily:`'Proza Libre', sans-serif`, fontSize: 'calc(30px + 1vw)', color: 'teal'}}>Post lockdown, I ...</h1>
            </Grid.Row>
            <Grid.Row>
              {user && (
                <Grid.Column>
